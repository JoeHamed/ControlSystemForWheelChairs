...
with map_face_mesh.FaceMesh(min_tracking_confidence=0.5) as face_mesh:
    ...
    while True:
        ...
        if results.multi_face_landmarks:
            ...
            utils.colorBackgroundText(frame,  f'Total Blinks: {TOTAL_BLINKS}', FONTS, 0.7, (50,150),2, textColor=(0,255,0))
            utils.colorBackgroundText(frame, f'Stop Blinks: {STOP_BLINKS}', FONTS, 0.7, (400, 150), 2, textColor=(0,0,255))
            utils.colorBackgroundText(frame, f'Move Blinks: {MOVE_BLINKS}', FONTS, 0.7, (750, 150), 2, textColor=(200,100,0))
